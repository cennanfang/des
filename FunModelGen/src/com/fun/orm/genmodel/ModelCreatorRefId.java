...
public class ModelCreatorRefId {
	...
	public ModelCreatorRefId(boolean isNeedAnnotation, boolean isNeedJavaUtilPackage, boolean isNeedJavaSqlsPackage, String packageOutPath,
	...
	private void processClassBody(StringBuffer sb) {
		for (int i = 0; i < colNames.size(); i++) {
			...
			if(ci != null && ci.getConstraintType().equals(ConstraintType.PRIMARY)) {
					if(isNeedAnnotation) {
