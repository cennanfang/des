...
public interface FunMapper<Model, PK> {
	 ...
	 * @return
	 */
	public List<Model> selectParam(Map<String, String> params);
	 ...
	 * @param model
	 */
	public void updateParam(Map<String, String> params);
	 ...
	 * @param model
	 */
	public void deleteParam(Map<String, String> params);
	 ...
	 * @return
	 */
	public int countParam(Map<String, String> params);
}
